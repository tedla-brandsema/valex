...
func init() {
	...
	tagex.RegisterDirective(&tag, &TimeBeforeValidator{})
	tagex.RegisterDirective(&tag, &TimeAfterValidator{})
	tagex.RegisterDirective(&tag, &TimeBetweenValidator{})
	tagex.RegisterDirective(&tag, &PositiveDurationValidator{})
	tagex.RegisterDirective(&tag, &NonZeroDurationValidator{})
	tagex.RegisterDirective(&tag, &NonZeroDurationAliasValidator{})
	tagex.RegisterDirective(&tag, &NonZeroIPValidator{})
	tagex.RegisterDirective(&tag, &NonZeroIPAliasValidator{})
	tagex.RegisterDirective(&tag, &IPRangeValidator{})
	tagex.RegisterDirective(&tag, &NonZeroURLValidator{})
	tagex.RegisterDirective(&tag, &NonZeroURLAliasValidator{})
